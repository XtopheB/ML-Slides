...
{c:/Gitmain/MLCourse/UNML/Module2/M2-1-SimpleClassification_files/figure-html/}{c:/GitMain/MLCourse/UNML/Module0/M0_files/figure-html/}
}
...
\begin{frame} % Cover slide
\frametitle{\textcolor{brique}{[Importance of the threshold ]}}
 \hfill \includegraphics[width = 0.2\textwidth]{Logit_Frontier-1.png}
\pause
 \begin{itemize}[<+->]
...
\pause
 \begin{itemize}[<+->]
  ...
  \item[$\hookrightarrow$] Examine them all!
   \item[]\includegraphics[width = 0.7\textwidth]{CVAUCfig-1.png}
\end{itemize}
\end{frame}
